...
function Header() {
  ...
  return (
    <header className="header">
      <h1 style={style}>Dough & Fire Pizza</h1>
    </header>
  );
}
  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        <React.Fragment>
          <p>
            Artisan pizza with a fiery twist — fresh dough, real flames, big
            flavor
          </p>
        ...
        <p>
          We’re perfecting every slice — menu drops soon! Come back soon for
          something 🔥
        </p>
      )}
...
function Order({ closeHour, openHour }) {
  return (
    <div className="order">
      <p>
        Doors open from {openHour}:00 until {closeHour}:00. Ovens hot. Cravings
        welcome. Come visit or order online
      </p>
